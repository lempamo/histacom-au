...
#
# Paths.py - convenient "constants" for the absolute paths of asset
# directories

import os

lib = os.path.dirname(os.path.realpath(os.path.abspath(__file__)))
root = os.path.abspath(os.path.join(lib, os.pardir))
